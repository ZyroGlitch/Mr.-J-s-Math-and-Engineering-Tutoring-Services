...
export default function Enroll() {
    ...
    const fileSubmit = async (e) => {
        ...
        if (error) {
            ...
            toast.success("You booked a session successfully, we will contact you soon.");
            resetForm();
        }
    }
    ...
    return (
        <>
            <section className="bg-cyan-300 grid grid-cols-2 h-[45vh] gap-4 px-24 pt-4">
                <div className='text-left flex flex-col justify-center w-[90%]'>
                    <p className="text-2xl font-bold mb-2">
                        Start Your Journey with Us Today! Enroll Now and Unlock Your Full Potential.
                    </p>
                    <p className="text-sm">
                        Join our tutoring program and experience personalized learning, expert guidance, and a supportive community. Enroll now to take the first step towards academic success and unlock your full potential with our dedicated tutors by your side.
                    </p>
                </div>

                <div className="relative ">
                    <img src="enrollNow.png" alt="image" className="absolute bottom-0 right-0 object-cover" />
                </div>
            </section>

            <section className="min-h-screen bg-cyan-50 px-24 pt-8 pb-[10rem]">
                <Breadcrumb className='mb-4'>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Enroll Now</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>

                <form onSubmit={fileSubmit}>
                    <h5 className="text-md text-cyan-600 font-semibold border-b border-gray-400 text-left flex items-center pb-2 mb-4">
                    ...
                    <div className='grid md:grid-cols-2 gap-4 mb-8'>
                        <div className="min-h-fit">
                            ...
                            <Input
                                ...
                                className='w-full rounded-md border border-slate-500/50 focus-visible:border-cyan-600 focus-visible:ring-0'
                                required
                    ...
                    <Textarea
                        ...
                        className='w-full h-[150px] rounded-md border border-slate-500/50 focus-visible:border-cyan-600 focus-visible:ring-0 mb-4'
                        value={data.additionalInfo}
                        onChange={(e) => setData({ ...data, additionalInfo: e.target.value })}
                    />

                    <div className="border border-cyan-500 bg-cyan-50 rounded-lg p-4 text-justify shadow mb-4">
                        <p className="text-sm text-muted-foreground">
                            Your information will be used solely for the purpose of enrolling you in our tutoring program and providing you with the best possible learning experience. We are committed to protecting your privacy and will not share your information with any third parties without your consent. By submitting this form, you agree to our privacy policy and terms of service.
                        </p>
                    </div>

                    <div className="flex">
                        <Button type='submit' className='bg-cyan-600 w-[200px] text-white rounded-md px-4 py-2 hover:bg-cyan-700'>
                            <span>Submit</span>
